...
function Footer() {
    ...
    return (
        <>
            <footer className="footer p-10 dark:bg-slate-800 bg-gray-200 w-full text-base-content">
                <nav>
            ...
            <footer className="footer px-10 py-4 border-t dark:bg-slate-800 bg-gray-200 text-base-content border-base-300">
